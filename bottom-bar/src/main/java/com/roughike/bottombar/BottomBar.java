...
public class BottomBar extends LinearLayout implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void updateTitleBottomPadding() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            int currentPadding = title.getPaddingBottom();
            Log.d("cz"," baseline " + baseline + "height" + height + " missingPadding " + missingPadding + " currentPadding " + currentPadding);

            if(title.getPaddingBottom() > 0){
                continue;
            }
